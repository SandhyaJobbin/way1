...
- Rig the Wayo SVG character with basic Framer Motion states.
...
## Phase 4: Triage Ops Vertical Slice (The Demo)

**Goal:** Ship a playable, end-to-end slice of one zone for stakeholder approval.

- Act 1: Wayo Intro sequence content.
- Zone 2: Triage Ops console UI and interaction.
- The Seam: Decision state propagation and end-of-demo success screen.
