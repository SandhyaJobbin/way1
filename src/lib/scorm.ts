 ...
 *   - SCORM.init() ΓÇö call early at app mount
...
// ΓöÇΓöÇ Public API ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ

export const SCORM = {
  /**
   * Initialize the SCORM connection.
   * Returns true if connected to an LMS, false if running locally.
   * Never throws ΓÇö always degrades gracefully.
   */
  init(): boolean {
    ...
    if (!_api) {
      console.warn(
        '[SCORM] No LMS API found ΓÇö running in local/standalone mode. ' +
    ...
    try {
      ...
      if (result === 'true') {
        console.info('[SCORM] LMSInitialize succeeded ΓÇö connected to LMS.')
        _initialized = true
        return true
      } else {
...
/**
 * initSCORM ΓÇö Call this once at app startup (before rendering).
